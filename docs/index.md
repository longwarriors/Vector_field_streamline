...
当前版本可以在浏览器中查看电偶极子、电四极子、六个正电荷、三对交替电荷、理想磁偶极子、线性 Halbach 阵列、圆形电流线圈、带电圆环、匀强场中的介质球与导体球，以及匀强场。点源可以增删和拖动，面内磁偶极矩还可旋转；圆环的两个截面标记则是只读几何。图中同时显示单位、枚举播种模式与具体说明、切片含义、双端终止统计、抑制数和实际渲染数；探针显示未被色标上下界裁剪的原始有限场值。
