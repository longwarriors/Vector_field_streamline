...
前端提供电偶极子、电四极子、六个正电荷、三对交替电荷、磁偶极子、线性 Halbach 阵列、圆形电流线圈、带电圆环和匀强场等预设。四个电荷预设只是默认排布不同，点电荷都可以增删和移动；磁偶极子还可编辑从 $+x$ 轴逆时针量取的面内方向角。Halbach 预设以八个依次旋转 90° 的理想点偶极为初始状态。圆环的 ⊙/⊗ 与带电圆环的两个 + 标记只表示同一个环穿过子午面的两个固定交点，不能拖动。
